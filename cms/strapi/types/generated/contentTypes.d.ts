...
export interface ApiLocationLocation extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    AddressPhoneInfo: Schema.Attribute.Text & Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    ...
    > &
      Schema.Attribute.Private;
    MapIframeLabel: Schema.Attribute.String;
    MapIframeSrc: Schema.Attribute.String;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Generic CMS-managed pages';
    displayName: 'Page';
    pluralName: 'pages';
    singularName: 'page';
  };
  ...
  attributes: {
    ...
    >;
    HideInNav: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    InternalNotes: Schema.Attribute.Text & Schema.Attribute.Private;
    IsSectionRoot: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<false>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    SEOTitleOverride: Schema.Attribute.String;
...
export interface ApiSiteSectionSiteSection extends Struct.CollectionTypeSchema {
  collectionName: 'site_sections';
  info: {
    displayName: 'Section';
    pluralName: 'site-sections';
    singularName: 'site-section';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    HeaderLabel: Schema.Attribute.String & Schema.Attribute.Required;
    InternalNotes: Schema.Attribute.Text & Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
